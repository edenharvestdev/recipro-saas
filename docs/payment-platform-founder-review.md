...
3. รอจนเห็นบล็อกข้อความ `PAYDASH DEMO SEEDED — 10 bills in shop "PAYDASH DEMO SHOP"` พร้อมอีเมล/รหัสผ่านที่พิมพ์ออกมา (สคริปต์สุ่มอีเมลใหม่ทุกครั้งที่รัน — ใช้ค่าที่พิมพ์ออกมาจริง อย่าเดา)
...
| 3 | คลิกเมนู "ชำระเงิน" | เข้าสู่หน้า **แดชบอร์ดการชำระเงิน** (`#paydashPage`), ระบบเรียก `loadPayDash()` อัตโนมัติ และแสดงตาราง 10 แถวที่ seed ไว้ |
